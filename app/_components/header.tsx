...
const Header = ({ type = "primary" }: HeaderProps) => {
  return type === "primary" ? (
    <div className="text-stroke-white z-10 flex h-12 w-full items-center justify-center overflow-clip border-b border-quarternary bg-dark font-primary text-[7vw] text-transparent sm:h-16 md:h-20 xl:h-24">
      <span className="w-full text-center opacity-30">
